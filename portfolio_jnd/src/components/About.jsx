        ...
        <div className='flex flex-col justify-center items-center w-full h-full'>
            <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8'>
                ...
                <p className='justify-center text-size-adjust'>I am a sophomore at the<p className=' text-[#99badd]'> University of North Carolina at Chapel Hill</p>
                        where I'm majoring in Computer Science(B.S) with a minor in Data Science and Business <Administration></Administration>. Some relevant courses I've taken include Data Structures and Analysis, Discrete Structures,
